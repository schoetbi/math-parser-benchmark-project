...
#define LUA_DIR	"C:/Program Files (x86)/lua"
/* #undef LUA_LDIR */
/* #undef LUA_CDIR */

#define LUA_PATH_DEFAULT ".\\?.lua;C:\\Program Files (x86)\\lua\\?.lua;C:\\Program Files (x86)\\lua\\?\\init.lua"
#define LUA_CPATH_DEFAULT ".\\?.dll;C:\\Program Files (x86)\\lua\\?.dll;C:\\Program Files (x86)\\lua\\loadall.dll"
